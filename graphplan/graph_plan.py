...
def interference(a1, a2):
    return one_directional_interference(a1, a2) or \
           one_directional_interference(a2, a1)


def inconsistent_effects(a1, a2):
    return one_directional_inconsistent_effects(a1, a2) or \
           one_directional_inconsistent_effects(a2, a1)


def one_directional_interference(a1, a2):
    a1_pre = a1.get_pre()
    for item in a1_pre:
...
def one_directional_inconsistent_effects(a1, a2):
    a1_add = a1.get_add()
    for item in a1_add:
        if a2.is_neg_effect(item):
            return True
